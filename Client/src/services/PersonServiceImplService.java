 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://services.jonas.com/", wsdlLocation = "http://localhost:8080/services/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://services.jonas.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/PersonService?wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://services.jonas.com/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.jonas.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
